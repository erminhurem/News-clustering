...
urlpatterns = [
    ...
    path('st/magazin/automobili', views.automobili_category,
         name="automobili_category"),
    path('st/magazin/tehnologija', views.tehnologija_category,
         name="tehnologija_category"),
    path('st/magazin/lifestyle', views.lifestyle_category,
    ...
    path('info/uslovi_indeksiranja/', views.uslovi_indeksiranja, name='uslovi_indeksiranja'),
    path('info/uslovi_koristenja/', views.uslovi_koristenja, name='uslovi_koristenja'),
    path('info/politika_privatnosti/', views.politika_privatnosti, name='politika_privatnosti'),
    path('info/time_site', views.time_site, name='time_site'),
    ...
    path('opstine/', views.opstine_view, name='opstine'),
    path('firme/<str:opstina>/', views.firme_view, name='firme'),    
    ...
    path('<str:kljucna_rijec>/', izvori.prikaz_izvora, name='prikaz_izvora'),
